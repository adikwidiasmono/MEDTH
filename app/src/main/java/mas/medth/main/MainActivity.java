...
import mas.medth.fragment.AccountFragment;
import mas.medth.fragment.InsuranceProductsFragment;
import mas.medth.fragment.NearbyHospitalFragment;
import mas.medth.fragment.TimelineFragment;
import mas.medth.fragment.ReservationFragment;
import mas.medth.fragment.MedicalHistoriesFragment;
import mas.medth.menu.DrawerAdapter;
import mas.medth.menu.DrawerItem;
import mas.medth.menu.SimpleItem;
...
public class MainActivity extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener, RatingDialogListener {
    ...
    private static final int POS_NEARBY_HOSPITAL = 6;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DrawerAdapter adapter = new DrawerAdapter(Arrays.asList(
                ...
                createItemFor(POS_NEARBY_HOSPITAL)));
    ...
    public void onItemSelected(int position) {
        ...
        switch (position) {
            ...
            case POS_NEARBY_HOSPITAL: {
                toolbar.setTitle("Nearby Hospital");
                selectedScreen = NearbyHospitalFragment.createFor(screenTitles[position]);
                break;
            }
            default: {
                break;
